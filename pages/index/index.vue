<template>
	<view class="container">
		...
		<map id="map_container" :latitude="latitude" :longitude="longitude" scale="11" :markers="markers"
			:style="'height:'+windowHeight+'px;width:' +windowWidth+'px;'" :show-location="true" @markertap="openMap" @updated='mapUpdated'
			@tap='closeMapMarker' :polyline="polyline">
	...
	export default {
		...
		methods: {
			...
			openMap(e) {
				...
				console.log('父点标记传递信息', this.muDD,this.cardInfo)
